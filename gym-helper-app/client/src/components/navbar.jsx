...
export default function Navbar() {
  return (
    <nav className="bg-gray-800 border-t border-dark dark:border-white dark:bg-gray-800 text-white dark:text-white fixed bottom-0 left-0 w-full py-4 px-8 z-50">
